...
- 但每次测试的**所有素材（图片、语音、文字）** 都从一个多模态素材库中**随机抽取**，保证每次内容新颖，**极大降低记忆特定内容的练习效应**。
